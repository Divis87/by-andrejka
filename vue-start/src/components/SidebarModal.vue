<template>
    <div v-if="show" :class="{ 'show-modal': show }" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="pointer-events-none fixed sm:inset-y-0 max-h-full overflow-x-scroll bottom-0 right-0 flex sm:max-w-full animate-slide-up sm:animate-slide-in duration-300">
